using HardwareOnlineStore.Services.Utilities.Caching.Support.Serializer.Abstractions;
using YamlDotNet.RepresentationModel;
using YamlDotNet.Serialization;
using YamlDotNet.Serialization.NamingConventions;

namespace HardwareOnlineStore.Services.Utilities.Caching.Support.Serializer.Yaml;
