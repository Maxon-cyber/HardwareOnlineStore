...
public sealed class ADOEntityWrapper<TEntity> : IEntityWrapper<TEntity>
    where TEntity : Entity, new()
{
    ...
    public ADOEntityWrapper(string provider, string prefix, DbConnection dbConnection, DbCommand dbCommand)
    {
